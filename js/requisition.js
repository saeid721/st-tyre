...
(function () {
    const REQUISITION_DATA = window.REQUISITION_CONFIG.DATA;
    ...
    const STATUS_MAP = window.REQUISITION_CONFIG.STATUS_MAP;
    const TYPE_MAP = window.REQUISITION_CONFIG.TYPE_MAP;
